...
This revision supersedes the earlier `0.5.2` dataset for official use.
The `0.5.1` and `0.5.2` files remain in the repository as historical evidence
of earlier freeze attempts, but they are not the official live-validation target.
