...
class BenchmarkFailureCode(StrEnum):
    ...
    PROVIDER_INTEGRATION_PROTOCOL = "PROVIDER_INTEGRATION_PROTOCOL"
    ...
    BENCHMARK_EVIDENCE_INVALID = "BENCHMARK_EVIDENCE_INVALID"
    UNKNOWN = "UNKNOWN"
...
class BenchmarkExecutionState:
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            ...
            "recovery_state": _json_ready(dict(self.recovery_state)) if self.recovery_state is not None else None,
        }
    ...
    def from_dict(cls, data: Mapping[str, Any]) -> "BenchmarkExecutionState":
        ...
        return cls(
            ...
            recovery_state=dict(data["recovery_state"]) if data.get("recovery_state") is not None else None,
        )
