...
def test_collects_normalized_evidence_from_storage(tmp_path: Path) -> None:
    ...
    writer.append(RunEvent(run_id=run_id, event_type=RunEventType.TOOL_REQUESTED, payload={"tool_name": "write_file"}))
    writer.append(RunEvent(run_id=run_id, event_type=RunEventType.TOOL_EXECUTED, payload={"tool_name": "write_file"}))
